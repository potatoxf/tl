...
import pxf.tl.image.captcha.generator.CodeGenerator;
import pxf.tl.image.captcha.generator.RandomGenerator;
...
public abstract class AbstractCaptcha implements ICaptcha {
    ...
    public void write(OutputStream out) {
        ToolIO.write(out, false, getImageBytes());
    }
    ...
    public BufferedImage getImage() {
        return ImgUtil.read(New.byteArrayInputStream(getImageBytes()));
    }
    ...
    public String getImageBase64Data() {
        return ToolURL.getDataUriBase64("image/png", getImageBase64());
    }
