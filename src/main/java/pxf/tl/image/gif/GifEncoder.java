...
public class GifEncoder {
    ...
    public boolean addFrame(BufferedImage im) {
        ...
        try {
            ...
            analyzePixels(); // build color table & proxyMap pixels
            if (firstFrame) {
            ...
            writePixels(); // encrypt and write pixel data
            firstFrame = false;
        } catch (IOException e) {
            ok = false;
        }
    ...
    /**
     * Analyzes image colors and creates color proxyMap.
     */
    protected void analyzePixels() {
        ...
        colorTab = nq.process(); // make reduced palette
        // convert proxyMap from BGR to RGB
        ...
        // proxyMap image pixels to new palette
        int k = 0;
    ...
    protected void getImagePixels() {
        ...
        if ((w != width) || (h != height) || (type != BufferedImage.TYPE_3BYTE_BGR)) {
            // make new image with right size/format
    ...
    protected void writeGraphicCtrlExt() throws IOException {
        ...
        if (transparent == null) {
            ...
            transp = 1;
            disp = 2; // force reset if using transparent color
        }
        if (dispose >= 0) {
    ...
    protected void writeNetscapeExt() throws IOException {
        ...
        out.write(1); // loopExecute sub-block id
        writeShort(repeat); // loopExecute count (extra iterations, 0=repeat forever)
        out.write(0); // block terminator
    }
