    ...
    private class CellSet extends AbstractSet<Cell<R, C, V>> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Cell) {
                ...
                if (null != row) {
                    return ToolObject.equals(row.get(cell.getColumnKey()), cell.getValue());
                }
            }
            return false;
        }
    ...
    private static class SimpleCell<R, C, V> implements Cell<R, C, V>, Serializable {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Cell) {
                Cell<?, ?, ?> other = (Cell<?, ?, ?>) obj;
                return ToolObject.equal(rowKey, other.getRowKey())
                        && ToolObject.equal(columnKey, other.getColumnKey())
                        && ToolObject.equal(value, other.getValue());
            }
            return false;
        }
