...
public class CollectionValueMap<K, V> extends AbsCollValueMap<K, V, Collection<V>> {
    ...
    private final Supplier<Collection<V>> collectionCreateFunc;
     ...
     */
    public CollectionValueMap(float loadFactor, Map<? extends K, ? extends Collection<V>> m, Supplier<Collection<V>> collectionCreateFunc) {
     ...
     * @param collectionCreateFunc Map中值的集合创建函数
     */
    public CollectionValueMap(int initialCapacity, float loadFactor, Supplier<Collection<V>> collectionCreateFunc) {
