 ...
 * {@link #getDateTimeInstance(int, int, TimeZone, Locale)} Thanks to Apache Commons Lang 3.5
 */
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    /**
     * 便捷获取 DateTimeFormatter 由于 {@link DatePattern} 很大一部分的格式没有提供 {@link
     * DateTimeFormatter},因此这里提供快捷获取方式
     *
