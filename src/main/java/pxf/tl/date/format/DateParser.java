...
public interface DateParser extends DateBasic {
    ...
    /**
     * 根据给定格式更新{@link Calendar} Upon success, the ParsePosition index is updated to indicate how much
     * of the source text was consumed. Not all source text needs to be consumed. Upon parse failure,
     * ParsePosition error index is updated to the offset of the source text which does not match the
     * supplied format.
     *
