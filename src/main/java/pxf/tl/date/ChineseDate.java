...
public class ChineseDate {
    ...
    public String getChineseMonth(boolean isTraditional) {
        return ToolTime.getChineseMonthName(
                isLeapMonth(), isLeapMonth() ? this.month - 1 : this.month, isTraditional);
    }
    ...
    public Calendar getGregorianCalendar() {
        final Calendar calendar = ToolTime.calendar();
    ...
    public String getFestivals() {
        return ToolString.join(",", LunarFestival.getFestivals(this.year, this.month, day));
    }
    ...
    public String toStringNormal() {
        return String.format(
                "%04d-%02d-%02d", this.year, isLeapMonth() ? this.month - 1 : this.month, this.day);
    }

    @Override
    public String toString() {
        return String.format(
                "%s%s年 %s%s", getCyclical(), getChineseZodiac(), getChineseMonthName(), getChineseDay());
    }
     ...
     * @return 公历信息
     */
    private DateTime lunar2solar(
            int chineseYear, int chineseMonth, int chineseDay, boolean isLeapMonth) {
        // 超出了最大极限值
