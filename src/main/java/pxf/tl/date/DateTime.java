...
import pxf.tl.lang.BasicTypeConverter;
...
public class DateTime extends Date {
    ...
    public DateTime(Date date, TimeZone timeZone) {
        this(Safe.value(date, Date::new).getTime(), timeZone);
    }
    ...
    public DateTime(Instant instant, ZoneId zoneId) {
        this(instant.toEpochMilli(), ToolTime.toTimeZone(zoneId));
    }
    ...
    public DateTime(TemporalAccessor temporalAccessor) {
        this(BasicTypeConverter.convert(temporalAccessor, Instant.class));
    }
    ...
    public DateTime(long timeMillis, TimeZone timeZone) {
        super(timeMillis);
        this.timeZone = Safe.value(timeZone, TimeZone::getDefault);
    }
    ...
    public DateTime(CharSequence dateStr, String format) {
        this(
                GlobalCustomFormat.isCustomFormat(format)
    ...
    public DateTime(CharSequence dateStr, DateTimeFormatter formatter) {
        this(BasicTypeConverter.convert(formatter.parse(dateStr), Instant.class), formatter.getZone());
    }
    ...
    private static Date parse(CharSequence dateStr, DateFormat dateFormat) {
        ...
        try {
            ...
            throw new DateException(
                    ToolString.format("Parse [{}] with format [{}] error!", dateStr, pattern), e);
        }
    }
    ...
    private static Calendar parse(CharSequence dateStr, DateParser parser, boolean lenient) {
        ...
        final Calendar calendar = ToolTime.parse(dateStr, lenient, parser);
        if (null == calendar) {
    ...
    public DateTime offset(DateField datePart, int offset) {
        ...
        DateTime dt = mutable ? this : ToolObject.clone(this);
    ...
    public DateTime offsetNew(DateField datePart, int offset) {
        ...
        return ToolObject.clone(this).setTimeInternal(cal.getTimeInMillis());
    }
     ...
     *
     * <ul>
     *   <li>{@link DateTime#offset(DateField, int)}
     *   <li>{@link DateTime#setField(DateField, int)}
     *   <li>{@link DateTime#setField(int, int)}
     * </ul>
     * <p>
