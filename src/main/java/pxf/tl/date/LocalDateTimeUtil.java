...
public class LocalDateTimeUtil {
    ...
    public static LocalDateTime of(Instant instant, ZoneId zoneId) {
        ...
        return LocalDateTime.ofInstant(instant, Safe.value(zoneId, ZoneId::systemDefault));
    }
    ...
    public static LocalDateTime of(Instant instant, TimeZone timeZone) {
        ...
        return of(instant, Safe.value(timeZone, TimeZone::getDefault).toZoneId());
    }
    ...
    public static LocalDateTime parse(CharSequence text, String format) {
        ...
        if (Whether.noBlank(format)) {
            ...
            if (ToolString.startWithIgnoreEquals(format, DatePattern.PURE_DATETIME_PATTERN)) {
                final String fraction = ToolString.removePrefix(format, DatePattern.PURE_DATETIME_PATTERN);
                if (ToolRegex.isMatch("[S]{1,2}", fraction)) {
                    // 将yyyyMMddHHmmssS、yyyyMMddHHmmssSS的日期统一替换为yyyyMMddHHmmssSSS格式，用0补
                    text += ToolString.repeat('0', 3 - fraction.length());
                }
                formatter =
    ...
    public static String format(LocalDateTime time, DateTimeFormatter formatter) {
        return ToolTime.format(time, formatter);
    }
    ...
    public static String format(LocalDateTime time, String format) {
        return ToolTime.format(time, format);
    }
     ...
     *
     * @param date      {@link LocalDate}
     * @param formatter 日期格式化器，预定义的格式见：{@link DateTimeFormatter}; 常量如： {@link
     *                  DatePattern#NORM_DATE_FORMATTER}, {@link DatePattern#NORM_DATETIME_FORMATTER}
     * @return 格式化后的字符串
     */
    public static String format(LocalDate date, DateTimeFormatter formatter) {
        return ToolTime.format(date, formatter);
    }
     ...
     *
     * @param date   {@link LocalDate}
     * @param format 日期格式，类似于yyyy-MM-dd, 常量如 {@link DatePattern#NORM_DATE_PATTERN}, {@link
    ...
    public static LocalDateTime offset(LocalDateTime time, long number, TemporalUnit field) {
        return ToolTime.offset(time, number, field);
    }
     ...
     * @see ToolTime#between(Temporal, Temporal)
     */
    public static Duration between(LocalDateTime startTimeInclude, LocalDateTime endTimeExclude) {
        return ToolTime.between(startTimeInclude, endTimeExclude);
    }
    ...
    public static long between(
        ...
        return ToolTime.between(startTimeInclude, endTimeExclude, unit);
    }
     ...
     *
     * <ul>
     *   <li>毫秒不归零：2020-02-02 23:59:59,999
     *   <li>毫秒归零：2020-02-02 23:59:59,000
     * </ul>
     *
     * @param time                日期时间
     ...
     * @see ToolTime#toEpochMilli(TemporalAccessor)
     */
    public static long toEpochMilli(TemporalAccessor temporalAccessor) {
        return ToolTime.toEpochMilli(temporalAccessor);
    }
    ...
    public static boolean isOverlap(
            ChronoLocalDateTime<?> realStartTime,
     ...
     *
     * <ul>
     *   <li>如果一年的第一天是星期一，则第一周从第一天开始，没有零周
     *   <li>如果一年的第二天是星期一，则第一周从第二天开始，而第一天在零周
     *   <li>如果一年中的第4天是星期一，则第1周从第4周开始，第1至第3周在零周开始
     *   <li>如果一年中的第5天是星期一，则第二周从第5周开始，第1至第4周在第1周
     * </ul>
     *
    ...
    public static int weekOfYear(TemporalAccessor date) {
        return ToolTime.get(date, WeekFields.ISO.weekOfYear());
    }
    ...
    public static boolean isIn(
            ...
            ChronoLocalDateTime<?> beginDate,
            ChronoLocalDateTime<?> endDate) {
        return ToolTime.isIn(date, beginDate, endDate);
    }
}
