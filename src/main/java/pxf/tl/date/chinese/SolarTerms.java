...
import pxf.tl.date.ChineseDate;
...
public class SolarTerms {
    ...
    /**
     * 1900-2100各年的24节气日期速查表 此表来自：https://github.com/jjonline/calendar.js/blob/master/calendar.js
     */
    ...
    public static int getTerm(int y, int n) {
        ...
        return ToolNumber.parseInt(_calday[n - 1]);
    }
