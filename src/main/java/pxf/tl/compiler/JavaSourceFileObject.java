...
class JavaSourceFileObject extends SimpleJavaFileObject {
     ...
     * @param code      需要编译的类源码
     */
    protected JavaSourceFileObject(String className, String code, Charsets charsets) {
        this(className, New.byteArrayInputStream(code, charsets));
    }
    ...
    protected JavaSourceFileObject(String name, InputStream inputStream) {
        this(ToolURL.getStringURI(name.replace(PoolOfCharacter.DOT, PoolOfCharacter.SLASH) + Kind.SOURCE.extension));
