 ...
 * jdk8中如果直接调用{@link MethodHandles#lookup()}获取到的{@link
 * MethodHandles.Lookup}在调用findSpecial和unreflectSpecial 时会出现权限不够问题，抛出"no private access for
 * invokespecial"异常，因此针对JDK8及JDK9+分别封装lookup方法。
 *
 * <p>参考：
 *
 * <p><a
 * href="https://blog.csdn.net/u013202238/article/details/108687086">https://blog.csdn.net/u013202238/article/details/108687086</a>
 *
 * @author potatoxf
 */
public class LookupFactory {
    ...
    public static MethodHandles.Lookup lookup(Class<?> callerClass) {
        ...
        if (privateLookupInMethod != null) {
            try {
                return (MethodHandles.Lookup)
                        privateLookupInMethod.invoke(MethodHandles.class, callerClass, MethodHandles.lookup());
        ...
        try {
            ...
            throw new IllegalStateException(
                    "no 'Lookup(Class, int)' method in java.lang.invoke.MethodHandles.", e);
        }
    }
}
