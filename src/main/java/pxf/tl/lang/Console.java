...
public class Console {
    ...
    public static void log(Object obj1, Object... otherObjs) {
        if (Whether.empty(otherObjs)) {
            log(obj1);
        } else {
            log(buildTemplateSplitBySpace(otherObjs.length + 1), ToolArray.insert(otherObjs, 0, obj1));
        }
    }
    ...
    public static void log(String template, Object... values) {
        if (Whether.empty(values) || ToolString.contains(template, TEMPLATE_VAR)) {
            logInternal(template, values);
        } else {
            logInternal(
                    buildTemplateSplitBySpace(values.length + 1), ToolArray.insert(values, 0, template));
        }
    }
    ...
    public static void log(Throwable t, String template, Object... values) {
        out.println(ToolString.format(template, values));
        if (null != t) {
    ...
    public static void print(Object obj1, Object... otherObjs) {
        if (Whether.empty(otherObjs)) {
            ...
            print(buildTemplateSplitBySpace(otherObjs.length + 1), ToolArray.insert(otherObjs, 0, obj1));
        }
    }
    ...
    public static void printProgress(char showChar, int len) {
        print("{}{}", PoolOfCharacter.CR, ToolString.repeat(showChar, len));
    }
    ...
    private static void printInternal(String template, Object... values) {
        out.print(ToolString.format(template, values));
    }
    ...
    public static void error(Object obj1, Object... otherObjs) {
        if (Whether.empty(otherObjs)) {
            ...
            error(buildTemplateSplitBySpace(otherObjs.length + 1), ToolArray.insert(otherObjs, 0, obj1));
        }
    }
    ...
    public static void error(Throwable t, String template, Object... values) {
        err.println(ToolString.format(template, values));
        if (null != t) {
    ...
    private static String buildTemplateSplitBySpace(int count) {
        return ToolString.repeatAndJoin(TEMPLATE_VAR, count, ToolString.SPACE);
    }
}
