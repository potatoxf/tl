...
public class MultipartRequestInputStream extends BufferedInputStream {
     ...
     * @throws IOException 读取异常
     */
    public UploadFileHeader readDataHeader(Charsets encoding) throws IOException {
     ...
     * @throws IOException IO异常
     */
    protected String readDataHeaderString(Charsets charsets) throws IOException {
        ...
        skipBytes(3);
        return charsets == null ? data.toString() : data.toString(charsets.name());
    }
    // ---------------------------------------------------------------- copy
     ...
     * 读取字节流，直到下一个boundary
     *
     * @param charsets 编码，null表示系统默认编码
     * @return 读取的字符串
     * @throws IOException 读取异常
     */
    public String readString(Charsets charsets) throws IOException {
        final FastByteArrayOutputStream out = new FastByteArrayOutputStream();
        copy(out);
        return out.toString(charsets);
    }
