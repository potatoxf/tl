...
public class TextSimilarity {
     ...
     *
     * <ul>
     *   <li>只比较两个字符串字母、数字、汉字部分，其他符号去除
     *   <li>计算出两个字符串最大子串，除以最长的字符串，结果即为相似度
     * </ul>
     *
     * @param strA 字符串1
     * @param strB 字符串2
    ...
    public static double similar(String strA, String strB) {
        ...
        return ToolNumber.div(commonLength, temp);
    }
    ...
    public static String similar(String strA, String strB, int scale) {
        return ToolNumber.formatPercent(similar(strA, strB), scale);
    }
    ...
    private static String removeSign(String str) {
        ...
        StringBuilder sb = ToolString.builder(length);
