...
import pxf.tl.text.cron.pattern.matcher.AlwaysTrueMatcher;
import pxf.tl.text.cron.pattern.matcher.PartMatcher;
...
public class PatternParser {
    ...
    private static List<PatternMatcher> parseGroupPattern(String groupPattern) {
        final List<String> patternList = ToolString.splitTrim(groupPattern, '|');
