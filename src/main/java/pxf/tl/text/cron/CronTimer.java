...
public class CronTimer extends Thread implements Serializable {
    ...
    @Override
    public void run() {
        final long timerUnit =
                this.scheduler.config.matchSecond ? TIMER_UNIT_SECOND : TIMER_UNIT_MINUTE;
        ...
        if (LOGGER.isInfoEnabled()) {
            LOGGER.info("Hutool-cron timer stopped.");
        }
    }
    ...
    public synchronized void stopTimer() {
        this.isStop = true;
        ToolThread.interrupt(this, true);
    }
