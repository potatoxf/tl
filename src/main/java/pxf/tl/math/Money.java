 ...
 * 单币种货币类，处理货币算术、币种和取整。
 *
 * <p>感谢提供此方法的用户：https://github.com/dromara/hutool/issues/605
 *
...
public class Money implements Serializable, Comparable<Money> {
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code yuan}元{@code cent}分和缺省币种的货币对象。
     *
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code yuan}元{@code cent}分和指定币种的货币对象。
     *
     * @param yuan     金额元数，0的情况下表示元的部分从分中截取
     * @param cent     金额分数。
     * @param currency 货币单位
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}元和缺省币种的货币对象。
     *
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}元和指定币种{@code currency}的货币对象。
     *
     * @param amount   金额，以元为单位。
     * @param currency 币种。
     */
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}元和指定币种{@code currency}的货币对象。 如果金额不能转换为整数分，则使用指定的取整模式{@code
     * roundingMode}取整。
     *
     * @param amount       金额，以元为单位。
     * @param currency     币种。
     ...
     * 构造器。
     *
     * <p>创建一个具有参数{@code amount}指定金额和缺省币种的货币对象。 如果金额不能转换为整数分，则使用四舍五入方式取整。
     *
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}和指定币种的货币对象。 如果金额不能转换为整数分，则使用四舍五入方式取整。
     *
     * <p>注意：由于double类型运算中存在误差，使用四舍五入方式取整的 结果并不确定，因此，应尽量避免使用double类型创建货币类型。 例： {@code
     * assertEquals(999, Math.round(9.995 * 100)); assertEquals(1000, Math.round(999.5)); money = new
     * Money((9.995)); assertEquals(999, money.getCent()); money = new Money(10.005);
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}和缺省币种的货币对象。 如果金额不能转换为整数分，则使用缺省取整模式{@code DEFAULT_ROUNDING_MODE}取整。
     *
     * @param amount 金额，以元为单位。
     */
     ...
     * 构造器。
     *
     * <p>创建一个具有参数{@code amount}指定金额和缺省币种的货币对象。 如果金额不能转换为整数分，则使用指定的取整模式{@code roundingMode}取整。
     *
     * @param amount       金额，以元为单位。
     * @param roundingMode 取整模式
     */
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}和指定币种的货币对象。 如果金额不能转换为整数分，则使用缺省的取整模式{@code DEFAULT_ROUNDING_MODE}进行取整。
     *
     * @param amount   金额，以元为单位。
     * @param currency 币种
     */
     ...
     * 构造器。
     *
     * <p>创建一个具有金额{@code amount}和指定币种的货币对象。 如果金额不能转换为整数分，则使用指定的取整模式{@code roundingMode}取整。
     *
     * @param amount       金额，以元为单位。
     * @param currency     币种。
     * @param roundingMode 取整模式。
     ...
     * 货币比较。
     *
     * <p>比较本货币对象与另一货币对象的大小。 如果待比较的两个货币对象的币种不同，则抛出{@code java.lang.IllegalArgumentException}。
     ...
     * 货币比较。
     *
     * <p>判断本货币对象是否大于另一货币对象。 如果待比较的两个货币对象的币种不同，则抛出{@code java.lang.IllegalArgumentException}。
     ...
     * 货币累乘。
     *
     * <p>本货币对象金额乘以乘数，并返回本货币对象。 如果相乘后的金额不能转换为整数分，使用缺省的取整方式 {@code DEFUALT_ROUNDING_MODE}进行取整。
     *
     * @param val 乘数
     * @return 累乘后的结果。
     */
     ...
     * 货币累乘。
     *
     * <p>本货币对象金额乘以乘数，并返回本货币对象。 如果相乘后的金额不能转换为整数分，使用指定的取整方式 {@code roundingMode}进行取整。
     *
     * @param val          乘数
     * @param roundingMode 取整方式
     * @return 累乘后的结果。
     ...
     * 货币累除。
     *
     * <p>本货币对象金额除以除数，并返回本货币对象。 如果相除后的金额不能转换为整数分，使用缺省的取整模式 {@code DEFAULT_ROUNDING_MODE}进行取整。
     *
     * @param val 除数
     * @return 累除后的结果。
     */
     ...
     * 货币累除。
     *
     * <p>本货币对象金额除以除数，并返回本货币对象。 如果相除后的金额不能转换为整数分，使用指定的取整模式 {@code roundingMode}进行取整。
     *
     * @param val          除数
     ...
     * 货币分配。
     *
     * <p>将本货币对象尽可能平均分配成{@code targets}份。 如果不能平均分配尽，则将零头放到开始的若干份中。分配 运算能够确保不会丢失金额零头。
     *
     ...
     *
     * <p>如果本货币对象与另一货币对象具有相同的币种，则方法返回。 否则抛出运行时异常{@code java.lang.IllegalArgumentException}。
     *
     * @param other 另一货币对象
     * @throws IllegalArgumentException 如果本货币对象与另一货币对象币种不同。
     */
