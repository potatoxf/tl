 ...
 *
 * <p>32-bit Java port of https://code.google.com/p/smhasher/source/browse/trunk/MurmurHash3.cpp#94
 * <br>
...
public class MurmurHash implements Serializable {
    ...
    public static int hash32(CharSequence data) {
        return hash32(ToolString.bytes(data, DEFAULT_CHARSET));
    }
    ...
    public static int hash32(byte[] data, int length, int seed) {
        ...
        for (int i = 0; i < nblocks; i++) {
            int i4 = i << 2;
            int k = ToolByte.bytesToInt(data, i4, DEFAULT_ORDER);
    ...
    public static long hash64(CharSequence data) {
        return hash64(ToolString.bytes(data, DEFAULT_CHARSET));
    }
    ...
    public static long hash64(byte[] data, int length, int seed) {
        ...
        for (int i = 0; i < nblocks; i++) {
            final int i8 = i << 3;
            long k = ToolByte.bytesToLong(data, i8, DEFAULT_ORDER);
    ...
    public static long[] hash128(CharSequence data) {
        return hash128(ToolString.bytes(data, DEFAULT_CHARSET));
    }
    ...
    public static long[] hash128(byte[] data, int length, int seed) {
        ...
        for (int i = 0; i < nblocks; i++) {
            final int i16 = i << 4;
            long k1 = ToolByte.bytesToLong(data, i16, DEFAULT_ORDER);
            long k2 = ToolByte.bytesToLong(data, i16 + 8, DEFAULT_ORDER);
