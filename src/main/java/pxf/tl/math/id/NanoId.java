 ...
 *
 * <ul>
 *   <li>安全：它使用加密、强大的随机 API，并保证符号的正确分配
 *   <li>体积小：只有 258 bytes 大小（压缩后）、无依赖
 *   <li>紧凑：它使用比 UUID (A-Za-z0-9_~)更多的符号
 * </ul>
 *
 * <p>此实现的逻辑基于JavaScript的NanoId实现，见：https://github.com/ai/nanoid
 *
 * @author potatoxf
 */
public class NanoId {
     ...
     */
    private static final SecureRandom DEFAULT_NUMBER_GENERATOR = ToolRandom.getSecureRandom();
    /**
