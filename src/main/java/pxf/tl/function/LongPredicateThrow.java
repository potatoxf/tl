 ...
 * {@code long}-consuming primitive type specialization of {@link PredicateThrow}.
 *
 ...
 */
@FunctionalInterface
public interface LongPredicateThrow<E extends Throwable> extends LongPredicate {
     ...
     */
    boolean testThrow(long value) throws E;
     ...
     */
    default LongPredicateThrow<E> and(LongPredicateThrow<? extends E> other) {
     ...
     */
    default LongPredicateThrow<E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default LongPredicateThrow<E> or(LongPredicateThrow<? extends E> other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
}
