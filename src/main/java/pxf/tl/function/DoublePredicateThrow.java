 ...
 * the {@code double}-consuming primitive type specialization of {@link PredicateThrow}.
 *
 ...
 */
@FunctionalInterface
public interface DoublePredicateThrow<E extends Throwable> extends DoublePredicate {
     ...
     */
    boolean testThrow(double value) throws E;
     ...
     */
    default DoublePredicateThrow<E> and(DoublePredicateThrow<? extends E> other) {
     ...
     */
    default DoublePredicateThrow<E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default DoublePredicateThrow<E> or(DoublePredicateThrow<? extends E> other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
}
