 ...
 * {@code int}-consuming primitive type specialization of {@link PredicateThrow}.
 *
 ...
 */
@FunctionalInterface
public interface IntPredicateThrow<E extends Throwable> extends IntPredicate {
     ...
     */
    boolean testThrow(int value) throws E;
     ...
     */
    default IntPredicateThrow<E> and(IntPredicateThrow<? extends E> other) {
     ...
     */
    default IntPredicateThrow<E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default IntPredicateThrow<E> or(IntPredicateThrow<? extends E> other) {
        Objects.requireNonNull(other);
        return (value) -> test(value) || other.test(value);
    }
}
