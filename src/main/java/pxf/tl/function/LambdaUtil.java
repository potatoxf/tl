...
public class LambdaUtil {
    ...
    public static <R> Class<R> getRealClass(Func0<?> func) {
        ...
        return ToolBytecode.forClassNameSilent(lambda.getImplClass());
    }
    ...
    public static <P, R> Class<P> getRealClass(Func1<P, R> func) {
        ...
        return ToolBytecode.forClassNameSilent(ToolString.sub(instantiatedMethodType, 2, ToolString.indexOf(instantiatedMethodType, ';')));
    }
    ...
    private static SerializedLambda _resolve(Serializable func) {
        return cache.computeIfAbsent(func.getClass().getName(), (key) -> ToolBytecode.invokeSilent(func, "writeReplace"));
    }
    //endregion
}
