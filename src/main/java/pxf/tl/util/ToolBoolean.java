 ...
 * @author potatoxf
 */
public final class ToolBoolean {

    /**
     * 表示为真的字符串
     */
    private static final Set<String> TRUE_SET =
            New.set(true, "true", "yes", "y", "t", "ok", "1", "on", "是", "对", "真", "對", "√");
    /**
     * 表示为假的字符串
     */
    private static final Set<String> FALSE_SET =
            New.set(true, "false", "no", "n", "f", "0", "off", "否", "错", "假", "錯", "×");
