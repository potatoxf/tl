 ...
 * @author potatoxf
 */
public final class ToolServiceLoader {
    ...
    public static <T> ServiceLoader<T> load(Class<T> clazz, ClassLoader loader) {
        return ServiceLoader.load(clazz, Safe.value(loader, ToolBytecode::getClassLoader));
    }
    ...
    public static <T> List<T> loadList(Class<T> clazz, ClassLoader loader) {
        return New.list(false, load(clazz, loader));
    }
}
