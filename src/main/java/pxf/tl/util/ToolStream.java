...
public final class ToolStream {
    ...
    public static <E, K, U> Map<K, Map<U, List<E>>> groupBy2Key(
        ...
        return groupBy(
                collection, key1, StreamUtil.groupingBy(key2, Collectors.toList()), isParallel);
    }
    ...
    public static <E, T, U> Map<T, Map<U, E>> group2Map(
        ...
        return groupBy(
                collection, key1, StreamUtil.toMap(key2, Function.identity(), (l, r) -> l), isParallel);
    }
    ...
    public static <E, K, D> Map<K, D> groupBy(
        ...
        return StreamUtil.of(collection, isParallel).collect(StreamUtil.groupingBy(key, downstream));
    }
