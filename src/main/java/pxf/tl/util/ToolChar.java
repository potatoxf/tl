...
public final class ToolChar {
    ...
    public static String toString(char c) {
        return c < PoolOfString.ASCII_CACHE.get().length ? PoolOfString.ASCII_CACHE.get()[c] : String.valueOf(c);
    }
    ...
    public static boolean isFileSeparator(char c) {
        return PoolOfCharacter.SLASH == c || PoolOfCharacter.BACKSLASH == c;
    }
     ...
     * </pre>
     *
     * <p>获取带圈数字 /封闭式字母数字 ，从1-20,超过1-20报错
     *
     * @param c 被转换的字符，如果字符不支持转换，返回原字符
     * @return 转换后的字符
     * @see <a
     * href="https://en.wikipedia.org/wiki/List_of_Unicode_characters#Unicode_symbols">Unicode_symbols</a>
     ...
     * @author potatoxf
     * @see <a
     * href="https://en.wikipedia.org/wiki/List_of_Unicode_characters#Unicode_symbols">维基百科wikipedia-Unicode_symbols</a>
     * @see <a
     * href="https://zh.wikipedia.org/wiki/Unicode%E5%AD%97%E7%AC%A6%E5%88%97%E8%A1%A8">维基百科wikipedia-Unicode字符列表</a>
     * @see <a href="https://coolsymbol.com/">coolsymbol</a>
     * @see <a
     * href="https://baike.baidu.com/item/%E7%89%B9%E6%AE%8A%E5%AD%97%E7%AC%A6/112715?fr=aladdin">百度百科
     * 特殊字符</a>
     */
