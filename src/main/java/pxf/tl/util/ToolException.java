 ...
 * @author potatoxf
 */
public final class ToolException {
    /**
     * 异常信息域
     */
    private static final Field DETAIL_MESSAGE_FIELD = getThrowableDetailMessageField();
    /**
     * @see Throwable#initCause(Throwable)
     */
    private static final Method INIT_CAUSE_METHOD = getThrowableInitCauseMethod();

    private ToolException() throws IllegalAccessException {
     ...
     * @return 返回堆栈打印的信息
     */
    public static String getStackTraceMessage(String message, Throwable... es) {
        StringWriter stringWriter = new StringWriter(10240);
        PrintWriter printWriter = new PrintWriter(stringWriter, true);
        printWriter.println(message);
        if (es != null) {
            int count = 1;
            for (Throwable throwable : es) {
                if (throwable == null) {
                    continue;
                }
     ...
     * @param message   信息
     */
    public static void initExceptionDetailMessage(Throwable throwable, String message) {
        if (throwable != null) {
     ...
     * @param cause     原因
     */
    public static void initExceptionInitCause(Throwable throwable, Throwable cause) {
        if (throwable != null) {
            INIT_CAUSE_METHOD.setAccessible(true);
            try {
    ...
    private static Field getThrowableDetailMessageField() {
        try {
            return Throwable.class.getDeclaredField("detailMessage");
        } catch (NoSuchFieldException e) {
            throw new RuntimeException(e);
        }
    }

    private static Method getThrowableInitCauseMethod() {
        try {
    ...
    public static String getMessage(Throwable e) {
        ...
        return ToolString.format("{}: {}", e.getClass().getSimpleName(), e.getMessage());
    }
    ...
    public static String getSimpleMessage(Throwable e) {
        return (null == e) ? PoolOfString.NULL : e.getMessage();
    }
    ...
    public static <T extends Throwable> T wrap(Throwable throwable, Class<T> wrapThrowable) {
        ...
        return ToolBytecode.createInstanceSilent(wrapThrowable, throwable);
    }
    ...
    public static StackTraceElement getStackElement(String fqcn, int i) {
        ...
        final int index =
                ToolArray.matchIndex((ele) -> ToolString.equals(fqcn, ele.getClassName()), stackTraceArray);
        if (index > 0) {
    ...
    public static String stacktraceToOneLineString(Throwable throwable, int limit) {
        ...
        replaceCharToStrMap.put(PoolOfCharacter.CR, ToolString.SPACE);
        replaceCharToStrMap.put(PoolOfCharacter.LF, ToolString.SPACE);
        replaceCharToStrMap.put(PoolOfCharacter.TAB, ToolString.SPACE);
    ...
    public static String stacktraceToString(
            Throwable throwable, int limit, Map<Character, String> replaceCharToStrMap) {
        ...
        if (Whether.noEmpty(replaceCharToStrMap)) {
            final StringBuilder sb = ToolString.builder();
            char c;
            String value;
            ...
            return ToolString.subPre(exceptionStr, limit);
        }
    }
    ...
    public static boolean isCausedBy(
            Throwable throwable, Class<? extends Exception>... causeClasses) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Throwable getCausedBy(
            Throwable throwable, Class<? extends Exception>... causeClasses) {
     ...
     */
    public static boolean isFromOrSuppressedThrowable(
            Throwable throwable, Class<? extends Throwable> exceptionClass, boolean checkCause) {
