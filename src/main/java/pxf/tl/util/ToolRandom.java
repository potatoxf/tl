...
public final class ToolRandom {
    ...
    public static double randomDouble(double min, double max, int scale, RoundingMode roundingMode) {
        return ToolNumber.round(randomDouble(min, max), scale, roundingMode).doubleValue();
    }
    ...
    public static double randomDouble(int scale, RoundingMode roundingMode) {
        return ToolNumber.round(randomDouble(), scale, roundingMode).doubleValue();
    }
    ...
    public static double randomDouble(double limit, int scale, RoundingMode roundingMode) {
        return ToolNumber.round(randomDouble(limit), scale, roundingMode).doubleValue();
    }
    ...
    public static BigDecimal randomBigDecimal() {
        return ToolNumber.toBigDecimal(getRandom().nextDouble());
    }
    ...
    public static BigDecimal randomBigDecimal(BigDecimal limit) {
        return ToolNumber.toBigDecimal(getRandom().nextDouble(limit.doubleValue()));
    }
    ...
    public static BigDecimal randomBigDecimal(BigDecimal min, BigDecimal max) {
        return ToolNumber.toBigDecimal(getRandom().nextDouble(min.doubleValue(), max.doubleValue()));
    }
    ...
    public static <T> List<T> randomEleList(List<T> source, int count) {
        ...
        final int[] randomList = ToolArray.sub(randomInts(source.size()), 0, count);
    ...
    public static <T> Set<T> randomEleSet(Collection<T> collection, int count) {
        final ArrayList<T> source = ToolCollection.distinct(collection);
        if (count > source.size()) {
    ...
    public static int[] randomInts(int length) {
        final int[] range = ToolArray.range(length);
        for (int i = 0; i < length; i++) {
            int random = randomInt(i, length);
            ToolArray.swap(range, i, random);
        }
        return range;
    }
    ...
    public static String randomStringWithoutStr(int length, String elemData) {
        ...
        baseStr = ToolString.removeAll(baseStr, elemData.toLowerCase().toCharArray());
     ...
     */
    public static <T> WeightRandom<T> weightRandom(MutableObjectNumber<T>[] weightObjs) {
     ...
     * @return {@link WeightRandom}
     */
    public static <T> WeightRandom<T> weightRandom(Iterable<MutableObjectNumber<T>> weightObjs) {
        return new WeightRandom<>(weightObjs);
    }
