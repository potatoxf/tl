...
public final class ToolTime {
    ...
    private static final int SECOND = MILLIS * 60;
    ...
    public static int[] currentTime(@Nullable TimeZone timeZone) {
        return getTime(currentTimeMillis(timeZone));
    }

    public static int[] getTime(long timeMillis) {
        return new int[]{(int) ((timeMillis % HOUR) / MINUTE + 8), (int) ((timeMillis % MINUTE) / SECOND),
                (int) ((timeMillis % SECOND) / MILLIS), (int) (timeMillis % MILLIS)};
    }
    ...
    public static int differentDay(long beforeTimeMillis, long afterTimeMillis) {
        return (int) ((afterTimeMillis - beforeTimeMillis) / HOUR);
    }
    ...
    public static long nextDayTimeMillis(long timeMillis, int dayAmount) {
        return timeMillis + (long) HOUR * dayAmount;
    }
    ...
    public static void main(String[] args) {
        ...
        long time = 68221992626L;

        TimeZone timeZone = TimeZone.getDefault();
        System.out.println("System Default TimeZone: " + timeZone.getID());
        System.out.println("System Default TimeZone getRawOffset: " + timeZone.getRawOffset() / MINUTE);
        ...
        // 显示时间
        System.out.println("+s seconds:     " + time);
        time += timeZone.getRawOffset();
        System.out.println("================================");
        ...
        int[] ints = currentTime(TimeZone.getDefault());
        System.out.println();
