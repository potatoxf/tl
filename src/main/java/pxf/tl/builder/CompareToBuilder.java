 ...
 *
 * <p>在Bean对象中，所有相关字段都参与比对，继承的字段不参与。使用方法如下：
 *
 * <pre>
 ...
 *
 * <p>也可以使用{@link #reflectionCompare(Object, Object) reflectionCompare} 方法通过反射比较字段，使用方法如下：
 *
 * <pre>
 * public int compareTo(Object o) {
...
public class CompareToBuilder implements Builder<Integer> {
     ...
     * </ul>
     *
     * <p>如果被比较的两个对象都为<code>null</code>，被认为相同。
     *
     * @param lhs 第一个对象
     * @param rhs 第二个对象
    ...
    public static int reflectionCompare(
        ...
        return reflectionCompare(lhs, rhs, AnyIter.ofCollection(false, excludeFields).toArray(String[]::new));
    }
