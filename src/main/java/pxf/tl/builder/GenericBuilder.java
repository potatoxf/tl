package pxf.tl.builder;


import pxf.tl.api.Builder;
import pxf.tl.function.*;
...
/**
 * 通用Builder 参考: <a
 * href="https://blog.csdn.net/weixin_43935907/article/details/105003719">一看就会的java8通用Builder</a>
 *
 * <p>使用方法如下：
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>我们还可以对这样调用有参构造，这对于创建一些在有参构造中包含初始化函数的对象是有意义的：
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>还可能这样构建Map对象： {@code HashMap<String, String> colorMap = GenericBuilder
 * .of(HashMap<String,String>::new) .with(Map::put, "red", "#FF0000") .with(Map::put, "yellow",
 * "#FFFF00") .with(Map::put, "blue", "#0000FF") .build(); }
 *
 * <p>注意：本工具类支持调用的构造方法的参数数量不超过5个，一般方法的参数数量不超过2个，更多的参数不利于阅读和维护。
 *
 * @author potatoxf
 */
public class GenericBuilder<T> implements Builder<T> {
     ...
     * @return GenericBuilder对象
     */
    public static <T, P1> GenericBuilder<T> of(Constructor1<T, P1> instant, P1 p1) {
     ...
     * @return GenericBuilder对象
     */
    public static <T, P1, P2> GenericBuilder<T> of(Constructor2<T, P1, P2> instant, P1 p1, P2 p2) {
     ...
     * @return GenericBuilder对象
     */
    public static <T, P1, P2, P3> GenericBuilder<T> of(
            Constructor3<T, P1, P2, P3> instant, P1 p1, P2 p2, P3 p3) {
     ...
     * @return GenericBuilder对象
     */
    public static <T, P1, P2, P3, P4> GenericBuilder<T> of(
            Constructor4<T, P1, P2, P3, P4> instant, P1 p1, P2 p2, P3 p3, P4 p4) {
     ...
     * @return GenericBuilder对象
     */
    public static <T, P1, P2, P3, P4, P5> GenericBuilder<T> of(
            Constructor5<T, P1, P2, P3, P4, P5> instant, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) {
     ...
     * @return GenericBuilder对象
     */
    public <P1, P2> GenericBuilder<T> with(TrConsumer<T, P1, P2> consumer, P1 p1, P2 p2) {
