...
public class HashCodeBuilder implements Builder<Integer> {
     ...
     */
    /**
     * LiteralConstant to use in building the hashCode.
     */
    ...
    private static void reflectionAppend(
        ...
        try {
            ...
            for (final Field field : fields) {
                if (false == ToolArray.contains(excludeFields, field.getName())
    ...
    public static int reflectionHashCode(
        ...
        return reflectionHashCode(object, AnyIter.ofCollection(false, excludeFields).toArray(String[]::new));
    }
