 ...
 *
 * <p>两个对象equals必须保证hashCode值相等，hashCode值相等不能保证一定equals
 *
 * <p>使用方法如下：
 *
 * <pre>
...
public class EqualsBuilder implements Builder<Boolean> {
    ...
    static void unregister(final Object lhs, final Object rhs) {
        ...
        if (registry != null) {
            ...
            synchronized (EqualsBuilder.class) {
                ...
                if (registry != null && Whether.empty(registry)) {
                    REGISTRY.remove();
                }
            }
        }
    ...
    public static boolean reflectionEquals(
        ...
        return reflectionEquals(lhs, rhs, AnyIter.ofCollection(false, excludeFields).toArray(String[]::new));
    }
    ...
    private static void reflectionAppend(
        ...
        try {
            ...
            for (int i = 0; i < fields.length && builder.isEquals; i++) {
                ...
                if (false == ToolArray.contains(excludeFields, f.getName())
                        && (f.getName().indexOf('$') == -1)
    ...
    public EqualsBuilder append(final Object lhs, final Object rhs) {
        ...
        if (Whether.arrayObj(lhs)) {
            // 判断数组的equals
            return setEquals(ToolArray.equals(lhs, rhs));
        }
    ...
    /**
     * Test if two {@code float}s are equal byt testing that the pattern of bits returned by
     * doubleToLong are equal.
     *
     * <p>This handles NaNs, Infinities, and {@code -0.0}.
     *
