 ...
 *
 * <ol>
 *   <li>比如调用其他客户的接口，传入的入参有限，需要分批
 *   <li>比如mysql/oracle用in语句查询，超过1000可以分批
 *   <li>比如数据库取出游标，可以把游标里的数据一批一批处理
 * </ol>
 *
 * @param <T> 字段类型
 * @author potatoxf
 */
public class PartitionIter<T> implements Iter<List<T>>, Serializable {
    @Serial
