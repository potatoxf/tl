...
public class DateConverter extends AbstractConverter<Date> {
    ...
    protected java.util.Date convertInternal(Object value) {
        if (value == null || (value instanceof CharSequence && Whether.blank(value.toString()))) {
            return null;
        }
    ...
    private java.util.Date wrap(DateTime date) {
        ...
        throw new UnsupportedOperationException(
                ToolString.format("Unsupported target Date type: {}", this.targetType.getName()));
    }
