 ...
 *
 * <ul>
 *   <li>WGS84坐标系：即地球坐标系，中国外谷歌地图
 *   <li>GCJ02坐标系：即火星坐标系，高德、腾讯、阿里等使用
 *   <li>BD09坐标系：即百度坐标系，GCJ02坐标系经加密后的坐标系。百度、搜狗等使用
 * </ul>
 *
 * <p>坐标转换相关参考: https://tool.lu/coordinate/<br>
 * 参考：https://github.com/JourWon/coordinate-transform
 *
 * @author potatoxf
 */
public class ForCoordinate {
