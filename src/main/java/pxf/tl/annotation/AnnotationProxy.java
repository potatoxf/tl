...
public class AnnotationProxy<T extends Annotation>
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (null != alias) {
            ...
            if (Whether.noBlank(name)) {
                if (false == attributes.containsKey(name)) {
                    throw new IllegalArgumentException(ToolString.format("No method for alias: [{}]", name));
                }
    ...
    private Map<String, Object> initAttributes() {
        final Method[] methods = ToolBytecode.getMethods(this.type);
        ...
        for (Method method : methods) {
            ...
            attributes.put(method.getName(), ToolBytecode.invokeSilent(this.annotation, method));
        }
