...
/**
 * 用于在{@link SynthesizedAggregateAnnotation}中表示一个处于合成状态的注解对象。<br>
 * 当对多个合成注解排序时，默认使用{@link #DEFAULT_HIERARCHICAL_COMPARATOR}进行排序， 从保证合成注解按{@link
 * #getVerticalDistance()}与{@link #getHorizontalDistance()}的返回值保持有序， 从而使得距离根元素更接近的注解对象在被处理是具有更高的优先级。
 *
 * @author potatoxf
