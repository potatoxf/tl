...
/**
 * 表示注解的某个属性，等同于绑定的调用对象的{@link Method}方法。<br>
 * 在{@link SynthesizedAggregateAnnotation}的解析以及取值过程中， 可以通过设置{@link SynthesizedAnnotation}的注解属性，
...
public interface AnnotationAttribute {
    ...
    default Object getValue() {
        return ToolBytecode.invokeSilent(getAnnotation(), getAttribute());
    }
