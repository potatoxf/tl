...
public class VersionComparator implements Comparator<String>, Serializable {
    ...
    public int compare(String version1, String version2) {
        if (ToolObject.equal(version1, version2)) {
            return 0;
        }
        ...
        final List<String> v1s = ToolString.splitTrim(version1, PoolOfCharacter.DOT);
        final List<String> v2s = ToolString.splitTrim(version2, PoolOfCharacter.DOT);
