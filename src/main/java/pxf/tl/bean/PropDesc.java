...
public class PropDesc {
    ...
    public PropDesc(Field field, Method getter, Method setter) {
        this.field = field;
        this.getter = ToolClass.setAccessible(getter);
        this.setter = ToolClass.setAccessible(setter);
    }
    ...
    public Type getFieldType() {
        if (null != this.field) {
            return ToolClass.getType(this.field);
        }
    ...
    public Class<?> getFieldClass() {
        if (null != this.field) {
            return ToolClass.getClass(this.field);
        }
    ...
    private Type findPropType(Method getter, Method setter) {
        Type type = null;
        if (null != getter) {
            type = ToolClass.getReturnType(getter);
        }
        if (null == type && null != setter) {
            type = ToolClass.getParamType(setter, 0);
        }
        return type;
    }
    ...
    private Class<?> findPropClass(Method getter, Method setter) {
        Class<?> type = null;
        if (null != getter) {
            type = ToolClass.getReturnClass(getter);
        }
        if (null == type && null != setter) {
            type = ToolClass.getFirstParamClass(setter);
        }
        return type;
    }
