...
public class DynaBean implements Serializable {
    ...
    public DynaBean(Class<?> beanClass, Object... params) {
        this(ToolBytecode.createInstance(beanClass, params));
    }
    ...
    public DynaBean(Class<?> beanClass) {
        this(ToolBytecode.createInstance(beanClass));
    }
    ...
    public DynaBean(Object bean) {
        ...
        this.bean = bean;
        this.beanClass = ToolClass.getClass(bean);
    }
    ...
    public Object invoke(String methodName, Object... params) {
        return ToolBytecode.invokeSilent(this.bean, methodName, params);
    }
