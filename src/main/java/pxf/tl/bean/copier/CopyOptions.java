...
import pxf.tl.convert.TypeConverter;
...
public class CopyOptions implements Serializable {
    ...
    protected TypeConverter converter =
            (type, value) -> Convert.convertWithCheck(type, value, null, ignoreError);
    /**
     ...
     */
    public static CopyOptions create(
            Class<?> editable, boolean ignoreNullValue, String... ignoreProperties) {
    ...
    public CopyOptions setIgnoreProperties(String... ignoreProperties) {
        return setPropertiesFilter(
                (field, o) -> !ToolArray.contains(ignoreProperties, field.getName()));
    }
    ...
    protected Object editFieldValue(String fieldName, Object fieldValue) {
        return (null != this.fieldValueEditor)
                ? this.fieldValueEditor.apply(fieldName, fieldValue)
                : fieldValue;
    }
