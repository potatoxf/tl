...
public final class DataSize implements Comparable<DataSize> {
    ...
    /**
     * Obtain a DataSize from a text string such as {@code 12MB} using the specified default {@link
    ...
    private static DataUnit determineDataUnit(String suffix, DataUnit defaultUnit) {
        ...
        return (Whether.noEmpty(suffix) ? DataUnit.fromSuffix(suffix) : defaultUnitToUse);
    }
