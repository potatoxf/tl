...
public class MultiResource
    ...
    public MultiResource(Collection<Resource> resources) {
        if (resources instanceof List) {
            ...
            this.resources = New.list(false, resources);
        }
    }
    ...
    public BufferedReader getReader(Charsets charsets) {
        return resources.get(cursor).getReader(charsets);
    }

    @Override
    public String readStr(Charsets charsets) throws IORuntimeException {
        return resources.get(cursor).readStr(charsets);
    }
