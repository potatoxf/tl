...
public class ClassPathResource extends UrlResource {
    ...
    public ClassPathResource(String pathBaseClassLoader, ClassLoader classLoader, Class<?> clazz) {
        ...
        this.path = path;
        this.name = Whether.blank(path) ? null : FileUtil.getName(path);

        this.classLoader = Safe.value(classLoader, ToolClass::getClassLoader);
        this.clazz = clazz;
        initUrl();
    }
    // --------------------------------------------------------------------------------------
    ...
    public final String getAbsolutePath() {
        ...
        return FileUtil.normalize(ToolURL.getDecodedPath(this.url));
    }
    ...
    private String normalizePath(String path) {
        ...
        path = ToolString.removePrefix(path, PoolOfString.SLASH);
