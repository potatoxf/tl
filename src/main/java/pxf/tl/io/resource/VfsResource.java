...
public class VfsResource implements Resource {
    ...
    static {
        Class<?> virtualFile = ToolBytecode.loadClassSilent(VFS3_PKG + "VirtualFile", null);
        try {
    ...
    public boolean exists() {
        return ToolBytecode.invokeSilent(virtualFile, VIRTUAL_FILE_METHOD_EXISTS);
    }

    @Override
    public String getName() {
        return ToolBytecode.invokeSilent(virtualFile, VIRTUAL_FILE_METHOD_GET_NAME);
    }

    @Override
    public URL getUrl() {
        return ToolBytecode.invokeSilent(virtualFile, VIRTUAL_FILE_METHOD_TO_URL);
    }

    @Override
    public InputStream getStream() {
        return ToolBytecode.invokeSilent(virtualFile, VIRTUAL_FILE_METHOD_GET_INPUT_STREAM);
    }
    ...
    public long getLastModified() {
        return ToolBytecode.invokeSilent(virtualFile, VIRTUAL_FILE_METHOD_GET_LAST_MODIFIED);
    }
     ...
     */
    public long size() {
        return ToolBytecode.invokeSilent(virtualFile, VIRTUAL_FILE_METHOD_GET_SIZE);
    }
}
