...
public class WatchUtil {
    ...
    public static WatchMonitor createAll(URL url, int maxDepth, Watcher watcher) {
        return createAll(New.uri(url), maxDepth, watcher);
    }
    ...
    public static WatchMonitor createModify(URL url, int maxDepth, Watcher watcher) {
        return createModify(New.uri(url), maxDepth, watcher);
    }
    ...
    public static WatchKey register(
            Watchable watchable, WatchService watcher, WatchEvent.Kind<?>... events) {
        try {
