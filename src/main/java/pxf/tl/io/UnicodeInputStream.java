...
public class UnicodeInputStream extends InputStream {
    ...
    public static final UnicodeBOM UTF32LE_BOM =
            new UnicodeBOM("UTF-32LE", new byte[]{-1, -2, 0, 0});
    public static final UnicodeBOM UTF32BE_BOM =
            new UnicodeBOM("UTF-32BE", new byte[]{0, 0, -2, -1});
    ...
    public UnicodeInputStream(InputStream inputStream, boolean skipBOM)
    ...
    private UnicodeBOM match(UnicodeBOM matchEncoding, UnicodeBOM noMatchEncoding)
            throws IOException {
    ...
    private void pushback(UnicodeBOM matchBOM) throws IOException {
        int count = this.pos;
        int start = 0;
