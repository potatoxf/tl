...
public class BOMInputStream extends InputStream {
    ...
    private final Charsets defaultCharset;
     ...
     *
     * @param in              流
     * @param defaultCharsets 默认编码
     */
    public BOMInputStream(InputStream in, Charsets defaultCharsets) {
        this.in = new PushbackInputStream(in, BOM_SIZE);
        this.defaultCharset = defaultCharsets;
    }
    // ----------------------------------------------------------------- Constructor end
     ...
     * @return 默认编码
     */
    public Charsets getDefaultCharsets() {
