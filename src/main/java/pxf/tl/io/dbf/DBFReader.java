            ...
            for (int i = 0; i < this.header.fieldArray.length; i++) {
                ...
                switch (this.header.fieldArray[i].getDataType()) {
                    case 'C':
                        ...
                        recordObjects[i] = newString(b_array);
                        break;
                    ...
                    case 'F':
                        try {
                            ...
                            t_float = DBFBase.trimLeftSpaces(t_float);
                            if (t_float.length > 0 && !ToolArray.contains(t_float, (byte) '?')) {
                    ...
                    case 'N':
                        try {
                            ...
                            t_numeric = DBFBase.trimLeftSpaces(t_numeric);

                            if (t_numeric.length > 0 && !ToolArray.contains(t_numeric, (byte) '?')) {
