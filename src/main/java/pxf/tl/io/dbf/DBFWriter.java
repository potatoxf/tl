...
public class DBFWriter extends DBFBase {
     ...
     * @throws DBFException if the passed in file does exist but not a valid DBF file, or if an IO
     *                      error occurs.
     */
            ...
            switch (this.header.fieldArray[j].getDataType()) {
                case 'C':
                    if (objectArray[j] != null) {
                        ...
                        dataOutput.write(textPadding(str_value, this.header.fieldArray[j].getFieldLength()));
                    } else {

                        dataOutput.write(textPadding("", this.header.fieldArray[j].getFieldLength()));
                    }
                ...
                case 'N':
                    if (objectArray[j] != null) {
                        ...
                        dataOutput.write(
                                textPadding("?", this.header.fieldArray[j].getFieldLength(), DBFBase.ALIGN_RIGHT));
                    }
