...
public class DBFField {
    ...
    protected static DBFField createField(DataInput in) throws IOException {
        ...
        field.reserv1 = DBFBase.readLittleEndianInt(in); /* 12-15 */
        field.fieldLength = in.readUnsignedByte(); /* 16 */
        field.decimalCount = in.readByte(); /* 17 */
        field.reserv2 = DBFBase.readLittleEndianShort(in); /* 18-19 */
        field.workAreaId = in.readByte(); /* 20 */
        field.reserv2 = DBFBase.readLittleEndianShort(in); /* 21-22 */
    ...
    /**
     * @deprecated This method is depricated as of version 0.3.3.1 and is replaced by {@link #setName(
     *String)}.
     */
