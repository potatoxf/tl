package pxf.tl.database.sql.formatter;
...
import pxf.tl.database.sql.formatter.languages.Dialect;
...
public class SqlFormatter {
    ...
    public static class Formatter {
        ...
        private final Function<FormatConfig, AbstractSqlFormatter> underlying;

        private Formatter(Function<FormatConfig, AbstractSqlFormatter> underlying) {
