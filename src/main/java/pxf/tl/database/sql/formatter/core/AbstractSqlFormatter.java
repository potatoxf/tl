...
public abstract class AbstractSqlFormatter implements DialectConfigurator {
     ...
     */
    public AbstractSqlFormatter(FormatConfig cfg) {
        this.cfg = cfg;
    ...
    private String formatOpeningParentheses(Token token, String query) {
        ...
        if (Whether.empty(token.whitespaceBefore)
